...
class IdentityShadowEventType(StrEnum):
    ...
    BOOTSTRAP_WAITING_FOR_TERMINAL = "bootstrap_waiting_for_terminal"
    BOOTSTRAP_CONFIRMED = "bootstrap_confirmed"
    TRUSTED_ROLLOVER_ACCEPTED = "trusted_rollover_accepted"
    TRUSTED_ROLLOVER_REJECTED = "trusted_rollover_rejected"
    TERMINAL_SEED_OBSERVED = "terminal_seed_observed"
