...
def test_evaluator_accepts_recent_bullish_candle_for_call_confirmation() -> None:
...
def test_evaluator_ignores_latest_forming_candle_for_put_confirmation() -> None:
...
def test_evaluator_ignores_latest_forming_candle_for_call_confirmation() -> None:
